...
- Vitis 2025.1 for Versal-based devices
...
2. The Versal common toolkit available at: https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/embedded-platforms.html
...
As we need to prepare the package for the VEK280, we must first prepare the host-code. 
Remember to use the arch compiler! 
...
For the target VEK280 the building flow is slightly different 
```bash
