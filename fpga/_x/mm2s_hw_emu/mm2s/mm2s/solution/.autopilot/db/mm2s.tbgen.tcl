...
set C_modelArgList {
	...
	{ gmem2 int 128 regular {axi_master 0}  }
	{ size int 32 regular {axi_slave 0}  }
	{ inputA int 64 regular {axi_slave 0}  }
	{ inputB int 64 regular {axi_slave 0}  }
	{ outA int 128 regular {axi_s 1 volatile  { outA Data } }  }
	{ outB int 128 regular {axi_s 1 volatile  { outB Data } }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "inputA","offset": { "type": "dynamic","port_name": "inputA","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "inputB","offset": { "type": "dynamic","port_name": "inputB","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "size", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "inputA", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":35}} , 
 	{ "Name" : "inputB", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":36}, "offset_end" : {"in":47}} , 
 	{ "Name" : "outA", "interface" : "axis", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "outB", "interface" : "axis", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ outA_TDATA sc_out sc_lv 128 signal 5 } 
	{ outA_TVALID sc_out sc_logic 1 outvld 5 } 
	{ outA_TREADY sc_in sc_logic 1 outacc 5 } 
	{ outB_TDATA sc_out sc_lv 128 signal 6 } 
	{ outB_TVALID sc_out sc_logic 1 outvld 6 } 
	{ outB_TREADY sc_in sc_logic 1 outacc 6 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "outA_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "outA", "role": "TDATA" }} , 
 	{ "name": "outA_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "outA", "role": "TVALID" }} , 
 	{ "name": "outA_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "outA", "role": "TREADY" }} , 
 	{ "name": "outB_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "outB", "role": "TDATA" }} , 
 	{ "name": "outB_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "outB", "role": "TVALID" }} , 
 	{ "name": "outB_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "outB", "role": "TREADY" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5", "6", "7"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "79", "EstimateLatencyMax" : "536870990",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mm2s_Pipeline_VITIS_LOOP_47_1_fu_124", "Port" : "gmem1", "Inst_start_state" : "75", "Inst_end_state" : "76"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mm2s_Pipeline_VITIS_LOOP_47_1_fu_124", "Port" : "gmem2", "Inst_start_state" : "75", "Inst_end_state" : "76"}]},
			{"Name" : "size", "Type" : "None", "Direction" : "I"},
			{"Name" : "inputA", "Type" : "None", "Direction" : "I"},
			{"Name" : "inputB", "Type" : "None", "Direction" : "I"},
			{"Name" : "outA", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mm2s_Pipeline_VITIS_LOOP_47_1_fu_124", "Port" : "outA", "Inst_start_state" : "75", "Inst_end_state" : "76"}]},
			{"Name" : "outB", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mm2s_Pipeline_VITIS_LOOP_47_1_fu_124", "Port" : "outB", "Inst_start_state" : "75", "Inst_end_state" : "76"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mm2s_Pipeline_VITIS_LOOP_47_1_fu_124", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "mm2s_Pipeline_VITIS_LOOP_47_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3", "EstimateLatencyMax" : "536870914",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "outA", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "outA_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "outB", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "outB_TDATA_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_47_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mm2s_Pipeline_VITIS_LOOP_47_1_fu_124.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_outA_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_outB_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	mm2s {
		...
		inputA {Type I LastRead 2 FirstWrite -1}
		inputB {Type I LastRead 2 FirstWrite -1}
		outA {Type O LastRead -1 FirstWrite 1}
		outB {Type O LastRead -1 FirstWrite 1}}
	mm2s_Pipeline_VITIS_LOOP_47_1 {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "79", "Max" : "536870990"}
	, {"Name" : "Interval", "Min" : "80", "Max" : "536870991"}
]}
...
set Spec2ImplPortList { 
	...
	outA { axis {  { outA_TDATA out_data 1 128 }  { outA_TVALID out_vld 1 1 }  { outA_TREADY out_acc 0 1 } } }
	outB { axis {  { outB_TDATA out_data 1 128 }  { outB_TVALID out_vld 1 1 }  { outB_TREADY out_acc 0 1 } } }
}
