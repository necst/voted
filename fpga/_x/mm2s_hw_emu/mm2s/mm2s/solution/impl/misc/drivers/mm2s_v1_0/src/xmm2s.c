...
void XMm2s_Set_inputA(XMm2s *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMm2s_WriteReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTA_DATA, (u32)(Data));
    XMm2s_WriteReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTA_DATA + 4, (u32)(Data >> 32));
}

u64 XMm2s_Get_inputA(XMm2s *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMm2s_ReadReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTA_DATA);
    Data += (u64)XMm2s_ReadReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTA_DATA + 4) << 32;
    return Data;
}

void XMm2s_Set_inputB(XMm2s *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMm2s_WriteReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTB_DATA, (u32)(Data));
    XMm2s_WriteReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTB_DATA + 4, (u32)(Data >> 32));
}

u64 XMm2s_Get_inputB(XMm2s *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMm2s_ReadReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTB_DATA);
    Data += (u64)XMm2s_ReadReg(InstancePtr->Control_BaseAddress, XMM2S_CONTROL_ADDR_INPUTB_DATA + 4) << 32;
    return Data;
}
