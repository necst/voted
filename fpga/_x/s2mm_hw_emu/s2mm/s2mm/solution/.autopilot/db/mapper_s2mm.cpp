...
using hls::sim::Byte;
extern "C" void s2mm(Byte<4>*, int*, int, int);
extern "C" void apatb_s2mm_hw(volatile void * __xlx_apatb_param_input_stream, volatile void * __xlx_apatb_param_output_r, int __xlx_apatb_param_size) {
...
auto* sinput_stream = createStream((hls::stream<int>*)__xlx_apatb_param_input_stream);
  // DUT call
  s2mm(__xlx_output_r__tmp_vec.data(), sinput_stream->data<int>(), __xlx_offset_byte_param_output_r, __xlx_apatb_param_size);
...
sinput_stream->transfer((hls::stream<int>*)__xlx_apatb_param_input_stream);
}
